...
//  LocoMojo
//
//  Created by Richard Lichkus on 8/8/14.
...
+ (void)drawPinIcon;
{
    ...
    UIColor* color7 = [UIColor colorWithRed: 0.341 green: 0.341 blue: 0.341 alpha: 1];
    UIColor* color9 = [UIColor colorWithRed: 0.059 green: 0.199 blue: 0.598 alpha: 1];
...
+ (void)drawPin;
{
    ...
    //// Oval Drawing
    CGContextSaveGState(context);
    CGContextTranslateCTM(context, 12.75, 5);
    ...
    [rectanglePath moveToPoint: CGPointMake(12.5, 25)];
    [rectanglePath addLineToPoint: CGPointMake(13.5, 25)];
    [rectanglePath addLineToPoint: CGPointMake(14, 9)];
    [rectanglePath addLineToPoint: CGPointMake(12, 9)];
    [rectanglePath addLineToPoint: CGPointMake(12.5, 25)];
    [rectanglePath closePath];
    [UIColor.darkGrayColor setFill];
    [rectanglePath fill];
    ...
    [oval2Path moveToPoint: CGPointMake(11.5, 2.02)];
    [oval2Path addCurveToPoint: CGPointMake(10.19, 2.59) controlPoint1: CGPointMake(11.02, 2.07) controlPoint2: CGPointMake(10.56, 2.26)];
    [oval2Path addCurveToPoint: CGPointMake(9.61, 3.5) controlPoint1: CGPointMake(9.89, 2.85) controlPoint2: CGPointMake(9.7, 3.17)];
...
+ (void)drawAccuracyGaugeWithGpsAccuracy: (CGFloat)gpsAccuracy;
{
    ...
    NSDictionary* oval5FontAttributes = @{NSFontAttributeName: [UIFont fontWithName: @"Helvetica" size: 12], NSForegroundColorAttributeName: color9, NSParagraphStyleAttributeName: oval5Style};
